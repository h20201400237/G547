...
//LED is connected to these 2 GPIOs
#define GPIO_OUT (26)
#define GPIO_OUT1 (25)
...
//Interrupt handler for GPIO 6. This will be called whenever there is a raising edge detected. 
static irqreturn_t gpio_interrupt(int irq,void *dev_id) 
{
  ...
  local_irq_save(flag);
  toggle=1;
  led_logic = (0x01 ^ led_logic); // toggle the old value
